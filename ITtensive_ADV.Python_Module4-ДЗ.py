...
#Такой способ необходим, когда легенда строится не на основе данных самого графика, а из отдельного источника
...
1. Я приводил к нижнему регистру, а он к верхнему, что по сути одинаково
...
'''
4. У автора получилось, что 6 строчек не совпало и он просто вручную реплейсит названия одно на другое
...
там выведено жначение - 1e7, это координаты, указанные в десятках миллионов'''
