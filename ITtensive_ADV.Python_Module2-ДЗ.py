...
x = np.append(x, [2020]).reshape(len(data_avg2.index)+1, 1)#после аппнда надо снова решейпить. Обрати + 1 добавляем т.к. к x у нас добавился 1 элемент. (т.е. форма стала на +1 больше)
